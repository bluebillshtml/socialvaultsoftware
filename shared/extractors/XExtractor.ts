...
export class XExtractor extends BasePlatformExtractor {
  ...
  async extractMetadata(url: string): Promise<ContentMetadata> {
    try {
      ...
      this.handleError(error, 'Failed to extract X metadata');
    }
  }
  ...
  async getDownloadUrl(
    ...
    try {
      ...
      this.handleError(error, 'Failed to get X download URL');
    }
  }
