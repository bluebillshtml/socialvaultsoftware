...
export class LinkedInExtractor extends BasePlatformExtractor {
  ...
  async extractMetadata(url: string): Promise<ContentMetadata> {
    try {
      ...
      const author = $('meta[property="og:site_name"]').attr('content') || 'LinkedIn User';
      ...
      this.handleError(error, 'Failed to extract LinkedIn metadata');
    }
  }
  ...
  async getDownloadUrl(
    ...
    try {
      ...
      this.handleError(error, 'Failed to get LinkedIn download URL');
    }
  }
